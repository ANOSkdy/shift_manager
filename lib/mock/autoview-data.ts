...
export const autoShiftRows: AutoShiftRow[] = [
  { id: 'R0001', workDate: '2026-05-22', weekday: '金', employeeName: '藤田 健太', team: '機械班', assignedSite: '第3圃場', taskType: '定植', shiftType: '早朝', startTime: '05:00', endTime: '09:00', allocationStatus: '調整中', priority: '高' },
  ...
  { id: 'R0242', workDate: '2026-05-15', weekday: '金', employeeName: '高橋 美咲', team: '選果班', assignedSite: '低温倉庫', taskType: '出荷準備', shiftType: '午前', startTime: '08:00', endTime: '12:00', allocationStatus: '調整中', priority: '高' },
